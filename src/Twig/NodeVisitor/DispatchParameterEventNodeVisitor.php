...
namespace Drupal\wmtwig\Twig\NodeVisitor;

use Drupal\components\Template\ComponentsRegistry;
use Drupal\wmtwig\Twig\Node\DispatchParameterEventNode;
use Drupal\wmtwig\Twig\Node\InjectEventDispatcherNode;
...
class DispatchParameterEventNodeVisitor implements NodeVisitorInterface
{
    ...
    public function enterNode(Node $node, Environment $env): Node
    {
        ...
        $node->getNode('display_start')
            ->setNode('_wmtwig_template_parameter_event_dispatch', new DispatchParameterEventNode());

        $node->getNode('class_end')
            ->setNode('_wmtwig_template_parameter_event_dispatch', new InjectEventDispatcherNode());
